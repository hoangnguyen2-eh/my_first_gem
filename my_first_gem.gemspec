...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["Hoang Nguyen"]
  spec.email         = ["exmaple@email.com"]

  spec.summary       = %q{My first gem project}
  spec.description   = %q{A gem to call external API}
  spec.homepage      = "https://example.api.com"
  spec.license       = "MIT"
